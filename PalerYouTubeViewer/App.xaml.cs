...
using PalerIPTSolution.PalerDomain.Commands;
using PalerIPTSolution.PalerDomain.Queries;
using PalerIPTSolution.PalerFramework;
using PalerIPTSolution.PalerFramework.Commands;
using PalerIPTSolution.PalerFramework.Queries;
using PalerIPTSolution.PalerYouTubeViewer.Stores;
using PalerIPTSolution.PalerYouTubeViewer.ViewModels;
using PalerIPTSolution.PalerYouTubeViewer.HostBuilders;
using Microsoft.EntityFrameworkCore;

namespace PalerIPTSolution.PalerYouTubeViewer
{
    /// <summary>
